...
if __name__ == '__main__':
    ...
    hist = build_histogram('sons_of_martha.txt')
    print(hist)
    x = (most_frequent_word(hist))
    print("The most frequently occurring word is: " + x[0])
    print("# of occurrences : " + str(x[1]))
    #print(words_with_frequency(build_histogram('two_cities.txt'), 1))
